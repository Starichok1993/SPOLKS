...
void show_statistic()
{
	...
	printf("Packages send: %d, Packages received: %d, Packages lost: &d",
			&nsent, &nreceived, &(nsent - nreceived));
	printf("\nTime reception and transmission:");
	printf("\nMax: %d; Min: %d, Average: %d", &tmax, &tmin, &(tsum / received));
}
